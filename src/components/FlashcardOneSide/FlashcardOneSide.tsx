...
const FlashcardOneSide = memo(
  ({ term, sideType, changeLevel, isChangingLevel, isVisible, shouldAnimateCardFlip }: IProps) => {
    ...
    return (
      <Box
        ...
        {...(shouldAnimateCardFlip ? { className: isVisible ? "flipIn " : "flipOut" } : {})}
        sx={{
          position: "absolute",
          display: "flex",
